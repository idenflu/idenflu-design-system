...
export const Select = React.forwardRef<HTMLSelectElement, SelectProps>(
  (
    ...
    const isExpanded = Boolean(
      expanded || multiple || searchable || optionsNeedExpanded(options)
    );
    ...
    if (isExpanded) {
      ...
      return (
        <div
          className={classNames("if-field", `if-field--${state}`, className)}
        >
    ...
    return (
      ...
      >
        ...
        <select
          ...
          aria-invalid={
            state === "invalid" || state === "server-error" || undefined
          }
